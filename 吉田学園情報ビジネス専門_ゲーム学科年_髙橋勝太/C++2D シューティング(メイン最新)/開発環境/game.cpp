...
void CGame::Update(void)
{
	...
	//int nRand = rand() % 500;
	//int nRandPosX = rand() % 60 - 30;

	//int nRandPosZ = rand() % 10 - 20;

	//int nRandMoveY = rand() % 2;
	//nRandMoveY / 10;

	//if (nRand == 0)
	//{
	//	//オブジェクトの生成
	//	//CObject3D::Create(D3DXVECTOR3(nRandPosX, 80.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, -0.1f, 0.0f), 0);
	//	//CObject3D::Create(D3DXVECTOR3(nRandPosX, 80.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, -0.1f - nRandMoveY, 0.0f), 0);
	//}
}
...
void CGame::Attack(void)
{
	...
	//2
	{
		...
		//特殊攻撃に変更
		if (nTimeGame == WAVE_1 + 1 && nTimeCounter == 0)
		{
			CEnemy::NextAttack(2);
		}
