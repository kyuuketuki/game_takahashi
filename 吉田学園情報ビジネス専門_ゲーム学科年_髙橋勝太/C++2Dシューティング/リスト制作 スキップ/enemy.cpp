...
//目的地場所
D3DXVECTOR3 CEnemy::m_objective2;
D3DXVECTOR3 CEnemy::m_objective3;
D3DXVECTOR3 CEnemy::m_objective4;

//移動させたい番号
int CEnemy::m_nType2 = NULL;
int CEnemy::m_nType3 = NULL;
int CEnemy::m_nType4 = NULL;

//体力
int CEnemy::m_nLife = NULL;

//移動処理に使用
float CEnemy::m_fMove2 = NULL;
float CEnemy::m_fMove3 = NULL;
float CEnemy::m_fMove4 = NULL;

//移動処理に使用
bool CEnemy::m_bUse = false;
bool CEnemy::m_bUse2 = false;
bool CEnemy::m_bUse3 = false;

bool CEnemy::m_bAttack = false;

//特殊攻撃管理
int CEnemy::m_nNextAttack = false;
int CEnemy::m_nNextAttack2 = false;
int CEnemy::m_nNextAttack3 = false;
...
{
	CEnemy::m_bUse = false;
	CEnemy::m_bUse2 = false;
	CEnemy::m_bUse3 = false;
...
void CEnemy::Update(void)
{
	...
	//特殊攻撃
	if (m_nNextAttack == 1 || m_nNextAttack2 == 1)
	{
		//カウントを進める
		m_nAttackCnt2++;
	...
	if (m_nNextAttack == 2 || m_nNextAttack2 == 2)
	{
		if (m_nType == ENEMY_04)
		{
			//カウントを進める
	...
	if (m_nNextAttack == 3 || m_nNextAttack2 == 3)
	{
		if (m_nType == ENEMY_04)
		{
			//カウントを進める
	...
	if (m_nNextAttack == 4 || m_nNextAttack2 == 4)
	{
		if (m_nType == ENEMY_04)
		{
			//カウントを進める
	...
	if (m_nNextAttack == 5 || m_nNextAttack2 == 5)
	{
		if (m_nType == ENEMY_05)
		{
			//カウントを進める
	...
	if (m_nNextAttack == 6 || m_nNextAttack2 == 6)
	{
		if (m_nType == ENEMY_05)
		{
			//カウントを進める
	...
	if (m_nNextAttack == 7 || m_nNextAttack2 == 7)
	{
		if (m_nType == ENEMY_06)
		{
			//カウントを進める
	...
	if (m_nNextAttack == 8 || m_nNextAttack2 == 8)
	{
	...
	if (m_nNextAttack == 9 || m_nNextAttack2 == 9)
	{
		if (m_nType == ENEMY_05)
		{
			//カウントを進める
	...
	if (m_nNextAttack == 10 || m_nNextAttack2 == 10)
	{
		if (m_nType == ENEMY_04)
		{
			//カウントを進める
	...
	if (m_nNextAttack == 11 || m_nNextAttack2 == 11)
	{
		if (m_nType == ENEMY_05)
		{
			//カウントを進める
	...
	//ボス
	if (m_nNextAttack == 12 || m_nNextAttack2 == 12 || m_nNextAttack3 == 12)
	{
		if (m_nType == ENEMY_BOSS_01)
		{
			//カウントを進める
	...
	if (m_nNextAttack == 13 || m_nNextAttack2 == 13 || m_nNextAttack3 == 13)
	{
		if (m_nType == ENEMY_BOSS_01)
		{
			//カウントを進める
	...
	if (m_nNextAttack == 14 || m_nNextAttack2 == 14 || m_nNextAttack3 == 14)
	{
		if (m_nType == ENEMY_BOSS_01)
		{
			//カウントを進める
	...
	//NestMoveで設定したタイプを移動先を変更させる
	if (m_bUse2 == true)
	{
		//複数目的地がある場合
		if (m_nMoveType == m_nType4)
		{
			//目的地の変更
			m_objective = m_objective4;
