...
// 静的メンバ変数宣言
//LPDIRECT3DTEXTURE9 CScene2D::m_pVtxBuffPolygon = NULL;
...
void CScene2D::SetEffect(D3DXCOLOR col,float nData)
{
	...
	//// 頂点カラーの設定
	//pVtx[0].col = D3DXCOLOR(col.r, col.g, col.b, nData/5);
	//pVtx[1].col = D3DXCOLOR(col.r, col.g, col.b, nData/5);
	//pVtx[2].col = D3DXCOLOR(col.r, col.g, col.b, nData/5);
	//pVtx[3].col = D3DXCOLOR(col.r, col.g, col.b, nData/5);
