...
int nPointer_Tutorial = 0;
bool g_bPressTutorial = false;
...
void CTutorial::Update(void)
{
	...
	//画面切り替え
	if (pInputKeyboard->GetTrigger(DIK_RETURN) == true || CGamepad::IsButtonDown(A) == true || CGamepad::IsButtonDown(B) == true)
	{
		nPointer_Tutorial += 1;
		g_bPressTutorial = false;
	}
